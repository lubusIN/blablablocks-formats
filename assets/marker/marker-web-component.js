...
class BlaBlaBlocksMarker extends HTMLElement {
	...
	renderPath( type ) {
		const paths = {
			...
			double: `<path d="M8.4,143.1c14.2-8,97.6-8.8,200.6-9.2c122.3-0.4,287.5,7.2,287.5,7.2"></path>
					<path d="M8,19.4c72.3-5.3,162-7.8,216-7.8c54,0,136.2,0,267,7.8"></path>`,
			'double-underline': `<path d="M5,125.4c30.5-3.8,137.9-7.6,177.3-7.6c117.2,0,252.2,4.7,312.7,7.6"></path>
					<path d="M26.9,143.8c55.1-6.1,126-6.3,162.2-6.1c46.5,0.2,203.9,3.2,268.9,6.4"></path>`,
			'underline-zigzag': `<path
			...
			cross: `<path d="M497.4,23.9C301.6,40,155.9,80.6,4,144.4"></path>
